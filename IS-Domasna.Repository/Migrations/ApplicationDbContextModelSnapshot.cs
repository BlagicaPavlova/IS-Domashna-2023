...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IS_Domasna.Domain.DomainModels.EmailMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IS_Domasna.Domain.DomainModels.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("MovieAirTime")
            ...
            modelBuilder.Entity("IS_Domasna.Domain.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("IS_Domasna.Domain.DomainModels.TicketsInShoppingCart", b =>
                {
                    b.HasOne("IS_Domasna.Domain.DomainModels.ShoppingCart", "ShoppingCart")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IS_Domasna.Domain.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
